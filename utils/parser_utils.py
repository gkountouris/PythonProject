...
def add_data_arguments(parser):
    ...
    parser.add_argument("--graph", type=bool, default=True, help="Graph or no Graph that will be the question.",
                        required=False)
...
def add_optimization_arguments(parser):
    ...
    parser.add_argument("--total_epochs", type=int, default=100, nargs="?", help="Total epochs.", required=False)
